...
class EditUrun extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TextEditingController titleController =
        TextEditingController(text: urun?.productTitle);
    TextEditingController descriptionController = TextEditingController(
        text: urun
            ?.productDescription); // burada paranez iclerindeki bilgiler sayfa açılırken
    TextEditingController fabrikaFiyatController = TextEditingController(
        text: urun?.fabrikaFiyat); // onceki kaydı yuklemek icin yani sart degil
    TextEditingController toptanciFiyatController = TextEditingController(
        text: urun?.toptanciData); // bir problem cıkarırsa kaldırabilirsin
    TextEditingController kargoFiyatController =
        TextEditingController(text: urun?.kargoData);
    TextEditingController marketFiyatController =
        TextEditingController(text: urun?.marketData);
    TextEditingController gecmisFiyatController =
        TextEditingController(text: urun?.gecmisData);
